  ...
  <div class="span9 page_message">
    <section id="contents">
      <ul class="tab-nav nav">
        ...
        <li class=""><a href="<?php echo U('scoreimport');?>">成绩导入</a></li>
      </ul>
        ...
        <form id="form" action="<?php echo U('add?model='.$model['id']);?>" method="post" class="form-horizontal">
            	 <div class="form-item cf">
                   ...
                   <div class="form-item cf">
                    ...
                    <div class="controls">
                      <input type="text" class="text input-large" name="teacher" value="<?php echo ($data["teacher"]); ?>">
                    </div>
                  </div>
            ...
            <div class="form-item cf">
                ...
                <div class="controls">
                    <input type="datetime" name="sdate" class="text date" value="<?php echo ($data["sdate"]); ?>" placeholder="请选择日期" />
                </div>
            </div>
            <div class="form-item cf">
                <label class="item-label"><span class="need_flag">*</span>结束时间<span class="check-tips"></span></label>
                <div class="controls">
                    <input type="datetime" name="edate" class="text date" value="<?php echo ($data["edate"]); ?>" placeholder="请选择日期" />
                </div>
            </div>
            <div class="form-item cf">
                <label class="item-label"><span class="need_flag">*</span>总课数<span class="check-tips"></span></label>
                <div class="controls">
                    <input type="text" class="text input-large" name="length" value="<?php echo ($data["length"]); ?>">
                  ...
                  <div class="form-item cf">
                    ...
                    <div class="controls">
                      <label class="textarea input-large">
                          <textarea name="intro" style="width:700px; height:200px;"><?php echo ($data["intro"]); ?></textarea>
                          <?php echo hook('adminArticleEdit', array('name'=>'intro','value'=>$data.intro));?>
                      </label>
                    </div>
                  </div> 
