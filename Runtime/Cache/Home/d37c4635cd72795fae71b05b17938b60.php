      ...
      <div class="tab-content"> 
        ...
        <form id="form" action="<?php echo ($post_url); ?>" method="post" class="form-horizontal form-center">
            ...
            <div class="form-item cf">
                ...
                <div class="controls">
                    <span><?php echo ($data['studentID']); ?></span>
                </div>
            </div>
            <div class="form-item cf">
            ...
            <div class="form-item cf">
                ...
                <div class="controls">
                    <input type="datetime" name="arriveTime" class="text time" value="<?php echo ($data['arriveTime']); ?>" placeholder="请选择时间" />
                </div>
            </div>
            <div class="form-item cf">
                <label class="item-label">*</span>离开时间<span class="check-tips"></span></label>
                <div class="controls">
                    <input type="datetime" name="leaveTime" class="text time" value="<?php echo ($data['leaveTime']); ?>" placeholder="请选择时间" />
                </div>
            </div>
            <div class="form-item cf">
                ...
                <div class="controls">
                    <select name="state" value="<?php echo ($data['state']); ?>">
                        <?php if($data['state'] == 1): ?><option selected>正常</option>
                            <?php else: ?>
                            <option >正常</option><?php endif; ?>
                        <?php if($data['state'] == 2): ?><option selected>迟到</option>
                            <?php else: ?>
                            <option >迟到</option><?php endif; ?>
                        <?php if($data['state'] == 3): ?><option selected>早退</option>
                            <?php else: ?>
                            <option >早退</option><?php endif; ?>
                        <?php if($data['state'] == 4): ?><option selected>缺席</option>
                            <?php else: ?>
                            <option >缺席</option><?php endif; ?>
                    </select>
                </div>
            </div>
            <div class="form-item cf">
                ...
                <div class="controls">
                    <label class="textarea input-large">
                        <textarea name="description" value="<?php echo ($data['description']); ?>"><?php echo ($data['description']); ?></textarea>
                    </label>
                </div>
            </div>
