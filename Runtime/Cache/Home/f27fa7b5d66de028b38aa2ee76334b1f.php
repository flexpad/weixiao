  ...
  <div class="span9 page_message">
    <section id="contents">
        <ul class="tab-nav nav">
            <li class=""><a href="<?php echo U('lists');?>">考勤列表<b class="arrow fa fa-sort-up"></b></a></li>
            <li class="current"><a href="<?php echo U('import');?>">考勤导入<b class="arrow fa fa-sort-up"></b></a></li>
        </ul>
