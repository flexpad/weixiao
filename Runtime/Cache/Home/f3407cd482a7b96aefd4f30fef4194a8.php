...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <div class="tab-content"> 
        <!-- 表单 -->
        <?php $post_url || $post_url = U('edit?id='.$data['id'] . '&model='.$model['id'], $get_param); ?>
        <form id="form" action="<?php echo ($post_url); ?>" method="post" class="form-horizontal form-center">
            ...
            <div class="form-item cf">
                ...
                <div class="controls">
                    <input type="number" class="text" name="studentno" value="<?php echo ($data['studentno']); ?>">
                </div>
            </div>
            <div class="form-item cf">
            ...
            <div class="form-item cf">
                <label class="item-label">*</span>性别<span class="check-tips"></span></label>
                <div class="controls">
                    <select name="gender" value="$data['gender']">
                        <?php if($data['gender'] == 2): ?><option selected value = "2">女生</option>
                            <?php else: ?>
                            <option value = "2">女生</option><?php endif; ?>
                        <?php if($data['gender'] == 1): ?><option selected value = "1">男生</option>
                            <?php else: ?>
                            <option value = "1">男生</option><?php endif; ?>
                    </select>
                </div>
            </div>

            <div class="form-item cf">
                <label class="item-label">*</span>来自学校<span class="check-tips"></span></label>
                <div class="controls">
                    <input type="text" class="text input-large" name="school" value="<?php echo ($data['school']); ?>">
                </div>
            </div>
            <div class="form-item cf">
                <label class="item-label">*</span>年级<span class="check-tips"></span></label>
                <div class="controls">
                    <select name="grade" value="$data['grade']">
                        <?php if($data['grade'] == 1): ?><option selected value = "1">一年级</option>
                        <?php else: ?>
                            <option value = "1">一年级</option><?php endif; ?>
                        <?php if($data['grade'] == 2): ?><option selected value = "2">二年级</option>
                            <?php else: ?>
                            <option value = "2">二年级</option><?php endif; ?>
                        <?php if($data['grade'] == 3): ?><option selected value = "3">三年级</option>
                            <?php else: ?>
                            <option value = "3">三年级</option><?php endif; ?>
                        <?php if($data['grade'] == 4): ?><option selected value = "4">四年级</option>
                            <?php else: ?>
                            <option value = "4">四年级</option><?php endif; ?>
                        <?php if($data['grade'] == 5): ?><option selected value = "5">五年级</option>
                            <?php else: ?>
                            <option value = "5">五年级</option><?php endif; ?>
                        <?php if($data['grade'] == 6): ?><option selected value = "6">六年级</option>
                            <?php else: ?>
                            <option value = "6">六年级</option><?php endif; ?>
                        <?php if($data['grade'] == 7): ?><option selected value = "7">初中一年级</option>
                            <?php else: ?>
                            <option value = "7">初中一年级</option><?php endif; ?>
                        <?php if($data['grade'] == 8): ?><option selected value = "8">初中二年级</option>
                            <?php else: ?>
                            <option value = "8">初中二年级</option><?php endif; ?>
                        <?php if($data['grade'] == 9): ?><option selected value = "9">初中三年级</option>
                            <?php else: ?>
                            <option value = "9">初中三年级</option><?php endif; ?>
                        <?php if($data['grade'] == 10): ?><option selected value = "10">高中一年级</option>
                            <?php else: ?>
                            <option value = "10">高中一年级</option><?php endif; ?>
                        <?php if($data['grade'] == 11): ?><option selected value = "11">高中二年级</option>
                            <?php else: ?>
                            <option value = "11">高中二年级</option><?php endif; ?>
                        <?php if($data['grade'] == 12): ?><option selected value = "12">高中三年级</option>
                            <?php else: ?>
                            <option value = "12">高中三年级</option><?php endif; ?>
                    </select>
                </div>
            </div>
            <div class="form-item cf">
                <label class="item-label">*</span>联系电话<span class="check-tips"></span></label>
                <div class="controls">
