...
<link href="<?php echo ADDON_PUBLIC_PATH;?>/bindStudent.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">

<body>
<div id="container" class="container body user_bind_page">
    <div style="margin:20px auto; text-align:center" class="uicon"><img src="<?php echo ADDON_PUBLIC_PATH;?>/A1.jpg" width="150px;"/></div>
    <div style="text-align: center;margin-bottom: 20px"><?php echo ($oid); ?></div>

    <!-- 表单 -->
    <form class="bind_form form-horizontal" method="post" action="<?php echo addons_url('Student://Wap/bind');?>" id="form">
        <!-- 基础文档模型 -->
    ...
    <?php if(($care_count > 0)): ?><div style="text-align: center;margin-top: 20px">
            <p>您已经绑定了<span><?php echo ($care_count); ?></span>位学生</p>
            <p><a href ="<?php echo addons_url('Student://Wap/infor');?>">查看已绑定学生信息</a></p>
        </div><?php endif; ?>
</div>
<!-- 底部导航 -->
