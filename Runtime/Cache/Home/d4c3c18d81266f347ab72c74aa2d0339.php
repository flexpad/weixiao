  ...
  <div class="span9 page_message">
    <section id="contents">
      <ul class="tab-nav nav">
        <li class=""><a href="<?php echo U('lists');?>">学习资料</a></li>
        <li class="current"><a href="javascript:;">学生资料编辑<b class="arrow fa fa-sort"></b></a></li>
      </ul>
      <div class="tab-content"> 
        <!-- 表单 -->
        <form id="form" action="<?php echo U('add?model='.$model['id'], $get_param);?>" method="post" class="form-horizontal">
            <div class="form-item cf">
                    <label class="item-label"><span class="need_flag">*</span>阶段（小学、初中、高中或通用）<?php echo ($token); ?><span class="check-tips"></span></label>
                    <div class="controls">
                        <select name="stage">
            ...
            <div class="form-item cf">
                        ...
                        <div class="controls upload_file" rel="file" data-max="1" title="点击上传文件">
                            ...
                            <input type="hidden" name="file" value="<?php echo ($data["fileid"]); ?>"/>
